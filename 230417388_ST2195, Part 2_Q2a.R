...
avgdelay_years <- c(
  "2004" = mean(df_2004$Delay, na.rm = TRUE),
  "2005" = mean(df_2005$Delay, na.rm = TRUE),
  "2006" = mean(df_2006$Delay, na.rm = TRUE),
  "2007" = mean(df_2007$Delay, na.rm = TRUE),
  "2008" = mean(df_2008$Delay, na.rm = TRUE)
)
...
avgdailydelay[[year]] <- avg_daily
avgdailydelay_all <- bind_rows(avgdailydelay)
